...
@section('content')
    ...
    <div class="content-wrapper">
        @include('partials.contentHeader',['name' => 'Vai trò', 'key' => 'Thêm'])
                    ...
                    <div class="col-md-12">
                        <form action="{{route('roles.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 mt-3 col-12">
                                ...
                                <textarea type="text" name="display_name" class="form-control " placeholder="Mô tả" ></textarea>
                            </div>
                                                ...
                                                <div class="card-body col-12">
                                                    <h5 class="card-title">
                                                        <label class="checkbox-label">
                                                            <input type="checkbox" class="checkbox_child" name="permission_id[]" value="{{$itemChild->id}}">
                                                            {{$itemChild->name}}
                                                        </label>
                                                    </h5>
                                                </div>
